...
-   `mk_segment_times()`: Gets the split time for the track. All times are given in seconds.
...
The `mk_lss_folder()` function will list all lss files in a folder.
Then you can use `purrr::map()` to fetch split data for each file.
